...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "legendankit")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "legendankit")
    APP_URL = os.environ.get("APP_URL", "https://github.com/LEGEND-ANKIT")
    ...
    # please reopen
    # https://github.com/LEGEND-ANKIT
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "https://github.com/LEGEND-ANKIT"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @LEGENDXANKIT")
    ...
    ORIGINAL_CODE = "aHR0cHM6Ly9naXRodWIuY29tL0xFR0VORC1BTktJVC9NWS5URUxFR1JBTS5PUkctQk9UL3Jhdy9BTktJVC9hbmtpdC5weQ=="
